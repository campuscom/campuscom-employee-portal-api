from shared_models.models import EmployeeAccount
...
from app.serializers import EmployeeAccountSerializer, GetEmployeeAccountSerializer


class EmployeeAccountViewSet(viewsets.ModelViewSet, ViewDataMixin, PaginatorMixin):
    """
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        serializer = GetEmployeeAccountSerializer(employee)
        return Response(self.object_decorator(serializer.data))

    def list(self, request, *args, **kwargs):
        queryset = self.get_queryset()
        serializer = GetEmployeeAccountSerializer(queryset, many=True)
